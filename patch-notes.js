...
window.PATCH_NOTES = [
  {
    ...
    notes: [
      ...
      { tag: "New", text: "Stages end with a real climax now: the hordes thin out, you reach a big imposing GATE, and monsters pour out of it straight at you — hold the line and clear them all, then sprint through to win, instead of the level just ending on the spot." },
