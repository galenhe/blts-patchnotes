...
window.COMMITS = [
  ...
  { hash: "9cad40b", date: "2026-08-14", subject: "Crack: fix occluded pit — dark void sits above the deck, planks raised over it" },
  { hash: "8d8a965", date: "2026-08-14", subject: "Crack: rebuild as a collapsed-deck pit (3D) filling one side of the lane" },
  { hash: "23f5e4d", date: "2026-08-14", subject: "Crack obstacle: circular pit in part of the lane (jump or steer around)" },
  { hash: "235cf91", date: "2026-08-13", subject: "Diagonal mast: geometric hitbox that follows the beam height (clear zones)" },
  { hash: "c31a3d1", date: "2026-08-13", subject: "Mast obstacle: lay it DIAGONALLY — jump the low end OR slide the high end" },
  { hash: "aa2628a", date: "2026-08-13", subject: "Fix CS0104: drop 'using System' in LevelCompleteScreen (Random ambiguity); qualify System.Action" },
  { hash: "a6a6876", date: "2026-08-13", subject: "Obstacles: add barrel side-wall (stacked, ~1/3 lane, left or right — weave around)" },
  { hash: "5173f1b", date: "2026-08-13", subject: "In-game hearts: vertical lives HUD down the left edge" },
  { hash: "cb2f822", date: "2026-08-13", subject: "Clear screen: stars section — new stars fly into a star-total chip under coins" },
  { hash: "f84ce2c", date: "2026-08-13", subject: "Pirate-theme the daily wheel: ship's helm + skull hub; helm chip icon" },
  { hash: "a3f9588", date: "2026-08-13", subject: "Home: free daily reward chip (top-left) opening the reward wheel" },
  { hash: "62f58e3", date: "2026-08-13", subject: "Daily reward wheel: spin-to-win coins / lives / stars (+ bonus-stars grant)" },
  { hash: "ab23ec4", date: "2026-08-13", subject: "Clear screen facelift: every stage -> home + coin fly-up animation" },
  { hash: "e40d804", date: "2026-08-13", subject: "Story dialogue: per-line emotion portraits + Captain Barbossa's dialogue" },
  { hash: "d21a329", date: "2026-08-13", subject: "Lock in firepower model: escort fleet = normal fire; special = character-specific" },
  { hash: "d847a2b", date: "2026-08-13", subject: "Refresh CLAUDE.md to current state (fix documentation drift)" },
  { hash: "4cbdea5", date: "2026-08-12", subject: "Make boss achievements data-driven (ID lives on the BossArchetype asset)" },
  { hash: "7e00b02", date: "2026-08-12", subject: "Wire the 3 Play Games achievements (Kraken / Captain Barbossa / Levels)" },
  { hash: "120d5dc", date: "2026-08-12", subject: "Patch notes 0.9.33 — Cloud Save Ahoy (Play Games cloud save + sign-in)" },
  { hash: "e546df6", date: "2026-08-12", subject: "Activate Google Play Games cloud save (plugin + config + continuous push)" },
  { hash: "4650c5f", date: "2026-08-12", subject: "Settings: move Privacy Policy + Delete Account onto an 'OTHER' sub-page" },
  { hash: "14083a4", date: "2026-08-12", subject: "Settings: add in-game Privacy Policy + Delete Account links" },
  { hash: "e0cc864", date: "2026-08-12", subject: "Play Games achievements: map lifetime milestones -> Play Games unlocks" },
  { hash: "f7e1746", date: "2026-08-12", subject: "MONETIZATION: correct Data Safety answers to match filed form (ad ID required, Play Games User ID optional, ephemeral No, location No, deletion URL)" },
  { hash: "d1bab51", date: "2026-08-12", subject: "PlayGamesManager: suppress CS0067 for OnSignInChanged in ads-only build" },
  { hash: "00d1288", date: "2026-08-12", subject: "Docs: Play Games cloud-save setup checklist + spec Phase B status" },
  { hash: "8dec357", date: "2026-08-12", subject: "Cloud save Phase B (3/…): Diverged chooser UI + Settings connect button" },
  { hash: "15b49c5", date: "2026-08-12", subject: "Verify Save Sync: add CloudSyncFlow wiring tests (fake ICloudSave, no SDK)" },
  { hash: "2934ad7", date: "2026-08-12", subject: "Cloud save Phase B (2/…): Play Games auth + Snapshots transport" },
  { hash: "72cbe1a", date: "2026-08-12", subject: "Cloud save Phase B (1/…): SDK-agnostic sync core" },
  { hash: "b8deb9a", date: "2026-08-12", subject: "Deletion page: state that partial data deletion (without account deletion) is available" },
  { hash: "6ad87e3", date: "2026-08-12", subject: "Add account & data deletion page (Play requires a deletion URL once OAuth is declared)" },
  { hash: "22b6ebc", date: "2026-08-12", subject: "Add Privacy Settings button to home Settings (re-opens UMP consent form)" },
  { hash: "6db1895", date: "2026-08-12", subject: "DebugOverlay: use textWrappingMode (enableWordWrapping is obsolete)" },
  { hash: "aabf371", date: "2026-08-12", subject: "Fix build: UmpConsentProvider missing using UnityEngine (Debug.Log)" },
  { hash: "25538ff", date: "2026-08-12", subject: "Debug: on-screen log overlay for on-device testing + ad-flow logs" },
  { hash: "e2f4f32", date: "2026-08-12", subject: "patchnotes: regenerate commits.js" },
  ...
  { hash: "39038f4", date: "2026-08-07", subject: "Level select: keep a right-side boss-figure slot (loads art from Resources when it lands)" },
  { hash: "106bee2", date: "2026-08-07", subject: "Fix green tint on baked portraits: neutralize scene ambient + fog during the bake" },
  { hash: "f36263f", date: "2026-08-07", subject: "Revert the boss silhouette on level-select sections (for now)" },
  { hash: "b14cac0", date: "2026-08-07", subject: "Level select: loom a boss silhouette in each biome section" },
  { hash: "d2c994e", date: "2026-08-07", subject: "Fix CS8132: update the second Characters deconstruction for the new stars column" },
  { hash: "f428af8", date: "2026-08-07", subject: "PlayerAnimator: guard every parameter access against the controller's declared params" },
  { hash: "508375c", date: "2026-08-07", subject: "Home preview: only fire emotes the controller actually has (fixes shark warnings)" },
  { hash: "d53c5fc", date: "2026-08-07", subject: "Skins: add a star-total unlock path; Shark now earned at 75 lifetime stars (was IAP)" },
  { hash: "50145c5", date: "2026-08-07", subject: "Skins: tap a card to preview live; only EQUIP locks it in" },
  { hash: "2313827", date: "2026-08-07", subject: "Level select: unique procedural scene per biome card (not just a tint)" },
  { hash: "400dd2c", date: "2026-08-07", subject: "Animate the boss-round seal on the home strip (slow spin + gentle pulse)" },
  { hash: "ff4544b", date: "2026-08-07", subject: "Level UI polish: raise home strip, boss-round seals, themed biome backdrops" },
  { hash: "8e67d6c", date: "2026-08-07", subject: "Level select: biome-sectioned map of numbered icons, ascending from the bottom" },
  { hash: "9e68b16", date: "2026-08-07", subject: "Home screen: horizontal numbered level-progression strip above the nav" },
  { hash: "8f0ef2b", date: "2026-08-07", subject: "Armory: show gold balance + red 'affordable upgrade' dot on the ARMORY tab" },
  { hash: "8bed2e5", date: "2026-08-06", subject: "Faster base player run speed (curve was tuned low: L1 6->8, L100 14->16)" },
  { hash: "2bacb51", date: "2026-08-06", subject: "Fire the first-horde tip earlier so it lands before the wall hits" },
  { hash: "0b2acd5", date: "2026-08-06", subject: "Player fights in place at the gate stand: brawl (Punch) + hit-flinch (HitReact)" },
  { hash: "8a2374f", date: "2026-08-06", subject: "Faster regular mobs: raise base enemy move speed (L1 4->6, L100 14->17)" },
  { hash: "d0449be", date: "2026-08-06", subject: "EndZone: remove the black gateway placeholder wall (doors fill the opening now)" },
  { hash: "94d676a", date: "2026-08-06", subject: "patchnotes: revise 0.9.24 gate note for the swinging-gate cinematic" },
